    ...
    <div class="page-layout page-layout_size_2">
        <div class="content-row">
            ...
            <div class="content-row__col fs-0">
                <img src="<?= (new MyImagePublisher($model))->resizeInBox(480, 480, false, 'image')?>" data-pagespeed-url-hash="3400027100" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
            </div>
        </div>
    </div>
</section>