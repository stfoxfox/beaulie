...
<?php $form = ActiveForm::begin(['id' => 'edit-filter', 'class' => 'm-t']); ?>
                ...
                <div class="col-md-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div id="field-catalogcategoryfilterform-attribute_id-wrapper"<?= $formItem->attribute_id ? '' : ' style="display: none;"'?>>
