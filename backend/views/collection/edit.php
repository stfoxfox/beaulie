...
<?php $form = ActiveForm::begin(['id' => 'edit-collection', 'class' => 'm-t']); ?>
        ...
        <div class="col-md-12">
            <div class="row"><div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <?php if ($formItem->page_id): ?>
                        <div class="ibox-title">
                            <h5>Управление блоками страницы</h5>
                        </div>
                        <div class="ibox-content">
                            <div class="m-t m-b">
                                <a href="<?= Url::toRoute(['page/blocks', 'id' => $formItem->page_id])?>">Управление блоками страницы</a>
                            </div>
                        </div>
                        <?php endif; ?>
                        <div class="row m-t">
