...
<?php $form = ActiveForm::begin(['id' => 'add-brand', 'class' => 'm-t', 'options' => ['enctype' => 'multipart/form-data']]); ?>
            ...
            <div class="col-md-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <?= $form->field($formItem, 'file_name')->fileInput()->label("Логотип ")?>
                        <?= $form->field($formItem, 'brand_file_name')->fileInput()->label("Изображение ")?>
