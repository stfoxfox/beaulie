...
$(document).ready(function() {
    ...
    var dell_item = function () {
        ...
        swal({
            ...
            function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/page/dell-gallery-item.html",
                    data: {
                        'item_id': item_id,
                        _csrf: csrfToken
                    },
    ...
    var edit_item = function () {
        ...
        $('#pagepictureform-image_id').val(item_id);
        ...
        $('#cropper-example-2-modal').modal('show').on('shown.bs.modal', function () {
            ...
            $('#pagepictureform-image_id').val(null);
        });
    ...
    function showCoords(c) {
        $('#pagepictureform-x').val(c.x);
        $('#pagepictureform-y').val(c.y);
        $('#pagepictureform-h').val(c.height);
        $('#pagepictureform-w').val(c.width);
    }
    ...
    $('#picture-done-button').on('click',function(){
        ...
        $("#upload-picture-form").ajaxSubmit({
            url: '/page/block-add-picture.html',
            type: 'post',
            ...
            success: function(json){
                ...
                if(json.error){
                    ...
                    console.log($('#item_'+json.picture_id));
