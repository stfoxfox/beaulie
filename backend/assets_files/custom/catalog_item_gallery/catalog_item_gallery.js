...
$(document).ready(function() {
    ...
    var dell_item = function () {
        ...
        swal({
            ...
            function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/catalog/dell-gallery-item.html",
                    data: {
                        'item_id': item_id,
                        _csrf: csrfToken
                    },
    ...
    var edit_item = function () {
        ...
        $('#catalogitempictureform-image_id').val(item_id);
        ...
        $('#cropper-example-2-modal').modal('show').on('shown.bs.modal', function () {
            ...
            $('#catalogitempictureform-image_id').val(null);
        });
    ...
    function showCoords(c) {
        $('#catalogitempictureform-x').val(c.x);
        $('#catalogitempictureform-y').val(c.y);
        $('#catalogitempictureform-h').val(c.height);
        $('#catalogitempictureform-w').val(c.width);
    }
    ...
    $('#picture-done-button').on('click',function(){
        ...
        $("#upload-picture-form").ajaxSubmit({
            url: '/catalog/gallery-add-picture.html',
            type: 'post',
