...
$related_model_path =$widget->related_model_path;
?>
    ...
    <div class="ibox-content">
        ...
        <?php if($item) {
            ...
            <?php } else { ?>
                ...
                <div class="m-t m-b" id="<?=BaseHtml::getInputId($form,$widget->fileAttribute)?>_image-div" ><img id="<?=BaseHtml::getInputId($form,$widget->fileAttribute)?>_crop_img"  width="300" src="<?=(new MyImagePublisher($item))->resizeInBox(500, 500, false, 'file_name', $related_model_path)?>" alt="Picture"></div>
