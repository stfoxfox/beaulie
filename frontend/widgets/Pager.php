...
class Pager extends Widget
{
     ...
     * @var string
     */
    public $internalPageCssClass = 'pagination__item';
    /**
     * @var string the CSS class for the active (currently selected) page button.
     */
    public $activePageCssClass = 'pagination__item_active';
    /**
    ...
    protected function renderPageButtons()
    {
        ...
        for ($i = $beginPage; $i <= $endPage; ++$i) {
            $internal[] = $this->renderInternalPageButton($i + 1, $i, $this->internalPageCssClass, $this->disableCurrentPageButton && $i == $currentPage, $i == $currentPage);
        }
        $buttons[] = Html::tag('div', implode('', $internal), ['class' => 'pagination__center']);
        ...
        return Html::tag('div', Html::tag('div', implode("\n", $buttons), ['class' => 'pagination']), $this->options);
    }

    /**
     * Renders an internal page button.
     ...
     * @return string the rendering result
     */
    protected function renderInternalPageButton($label, $page, $class, $disabled, $active)
    {
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        if ($disabled) {
            Html::addCssClass($options, $this->disabledPageCssClass);
            return Html::tag('div', Html::a($label, '#', $linkOptions), $options);
        }
